...
// Result returned by the login() function so the calling page
// knows exactly what happened and can show the right message.
...
export function redirectToCorrectDashboard(user: User): void {
...
export function checkAccess(requiredRole: UserRole): User {
