...
const generalErrorEl = document.getElementById("general-error") as HTMLDivElement;
...
const demoAccountCards = document.querySelectorAll<HTMLElement>("[data-demo-email]");
