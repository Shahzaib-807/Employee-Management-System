...
import { getAllEmployees, addEmployee, updateEmployee, searchEmployees, filterEmployeesByDepartment, filterEmployeesByStatus, getUniqueDepartments, getTotalEmployees, getTotalDepartments, getAverageSalary, sortEmployees, employeesToCsv, validateEmployeeForm, } from "./employeeService.js";
import { getUserByEmployeeId, createEmployeeUser, validateCredentialsForm, getPasswordStrength, submitPasswordChangeRequest, getPendingRequestForUser, } from "./userService.js";
import { showToast, setFieldError, clearFieldErrors, formatCurrency, formatDate, formatDateTime, maskPassword, downloadTextFile, escapeHtml, } from "./ui.js";
...
const statNewEmployees = document.getElementById("stat-new-employees");
...
const myAccountEmail = document.getElementById("my-account-email");
const myAccountPassword = document.getElementById("my-account-password");
const myAccountRevealBtn = document.getElementById("my-account-reveal-btn");
const myAccountPendingBanner = document.getElementById("my-account-pending-banner");
const requestPasswordBtn = document.getElementById("request-password-btn");
const requestPasswordModalRoot = document.getElementById("request-password-modal-root");
...
// ------------------------------------------------------------
function openViewCredentialsModal(employeeId) {
  ...
  `;
    ...
    const toggleBtn = document.getElementById("view-cred-toggle");
    const passwordInput = document.getElementById("view-cred-password");
    overlay?.addEventListener("click", (event) => {
        if (event.target === overlay)
            credentialsModalRoot.innerHTML = "";
    });
...
requestPasswordBtn.addEventListener("click", () => {
  ...
  `;
    ...
    const passwordInput = document.getElementById("request-new-password");
    const confirmInput = document.getElementById("request-confirm-password");
    const strengthBar = document.getElementById("request-strength-bar");
    const strengthLabel = document.getElementById("request-strength-label");
    const close = () => {
        requestPasswordModalRoot.innerHTML = "";
    };
    overlay?.addEventListener("click", (event) => {
