...
import { getUserByEmployeeId, submitPasswordChangeRequest, getPendingRequestForUser, getPasswordStrength, } from "./userService.js";
import { showToast, setFieldError, clearFieldErrors, getInitials, formatCurrency, formatDate, formatDateTime, maskPassword, escapeHtml, } from "./ui.js";
...
const profileNameEl2 = document.getElementById("profile-name-2");
const profilePositionHeaderEl = document.getElementById("profile-position");
const profilePositionEl2 = document.getElementById("profile-position-2");
const profileEmailEl = document.getElementById("profile-email");
const profilePhoneEl = document.getElementById("profile-phone");
const profileDepartmentEl = document.getElementById("profile-department");
...
const profileJoiningDateEl = document.getElementById("profile-joining-date");
...
const accountRevealBtn = document.getElementById("account-reveal-btn");
const accountPendingBanner = document.getElementById("account-pending-banner");
...
function openEditProfileModal() {
  ...
  `;
    ...
    form.addEventListener("submit", (event) => {
        ...
        if (errors.phone)
            setFieldError("edit-phone", errors.phone);
        if (errors.address)
            setFieldError("edit-address", errors.address);
